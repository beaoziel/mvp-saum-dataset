...
def predictInputData(data):
    ...
    try:
        ...
        input_dataset["family_history_with_overweight"] = le.fit_transform(input_dataset["family_history_with_overweight"])
        ...
        atributtes= ["Gender","Age","Height","Weight","family_history_with_overweight","FAVC","FCVC","NCP","CAEC", 
